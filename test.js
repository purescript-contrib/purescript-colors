...
(function(exports) {
  ...
  var toRGBA$prime = function (v) {
      ...
      var rgb$prime1 = (function () {
          ...
          throw new Error("Failed pattern match at Color line 146, column 1 - line 147, column 1: " + [  ]);
      })();
      return {
          r: rgb$prime1.r + m, 
          g: rgb$prime1.g + m, 
  ...
  var cssStringHSLA = function (v) {
      ...
      throw new Error("Failed pattern match at Color line 161, column 1 - line 162, column 1: " + [ $55.constructor.name ]);
  };
...
(function(exports) {
  ...
  var colorBox = function (c) {
      var textColor = (function () {
          ...
          throw new Error("Failed pattern match at Test.Interactive line 36, column 5 - line 40, column 5: " + [ $33.constructor.name ]);
      })();
      var repr = Color.cssStringHSLA(c);
      var css = "background-color: " + (repr + (";" + ("width: 30%; height: 50px; display: inline-block;" + ("margin-top: 10px; margin-right: 10px; border: 1px solid black;" + ("padding: 5px; color: " + Color.cssStringHSLA(textColor))))));
  ...
  var interactiveColorList = new Test_FlareCheck.Interactive(function (ui) {
      ...
      return Prelude["<$>"](Flare.functorUI)(function ($58) {
          return Test_FlareCheck.SetHTML.create(pretty($58));
      })(ui);
  });
  var interactiveTColor = new Test_FlareCheck.Interactive(function (ui) {
      return Prelude["<$>"](Flare.functorUI)(function ($59) {
          return Test_FlareCheck.SetHTML.create(colorBox(runTColor($59)));
      })(ui);
  });
