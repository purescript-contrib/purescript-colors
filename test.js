...
(function(exports) {
  ...
  var luminance = function (col) {
      ...
      var f = function (c) {
          ...
          throw new Error("Failed pattern match at Color line 603, column 9 - line 606, column 9: " + [ c.constructor.name ]);
      };
      var g = f(val.g);
      var r = f(val.r);
      var b = f(val.b);
  ...
  var toXYZ = function (c) {
      ...
      var finv = function (c$prime) {
          ...
          throw new Error("Failed pattern match at Color line 365, column 5 - line 368, column 1: " + [ c$prime.constructor.name ]);
      };
      var g = finv(rec.g);
      var r = finv(rec.r);
      var b = finv(rec.b);
  ...
  var toLab = function (col) {
      ...
      var f = function (t) {
          ...
          throw new Error("Failed pattern match at Color line 383, column 5 - line 386, column 1: " + [ t.constructor.name ]);
      };
      ...
      return function (c1) {
          return function (c2) {
              return function (frac) {
                  ...
                  throw new Error("Failed pattern match at Color line 519, column 1 - line 519, column 34: " + [ v.constructor.name, c1.constructor.name, c2.constructor.name, frac.constructor.name ]);
              };
          };
      };
  };
  ...
  var textColor = function (c) {
      ...
      throw new Error("Failed pattern match at Color line 642, column 1 - line 642, column 28: " + [ c.constructor.name ]);
  };
  exports["RGB"] = RGB;
  exports["HSL"] = HSL;
  exports["LCh"] = LCh;
  ...
  var mkSimpleSampler = function (interpolate) {
      return function (v) {
          return function (x) {
                      ...
                      return function ($copy_v2) {
                          return function ($copy_v3) {
                              ...
                              function $tco_loop(v1, v2, v3) {
                                  ...
                                  throw new Error("Failed pattern match at Color.Scale line 124, column 5 - line 124, column 23: " + [ v1.constructor.name, v2.constructor.name, v3.constructor.name ]);
                              };
                              while (!$tco_done) {
              ...
              throw new Error("Failed pattern match at Color.Scale line 118, column 1 - line 118, column 65: " + [ interpolate.constructor.name, v.constructor.name, x.constructor.name ]);
          };
      };
  };                                                             
...
(function(exports) {
  ...
  var toString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 104, column 1 - line 105, column 1: " + [ v.constructor.name ]);
  };
  var toColorScale = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 116, column 1 - line 116, column 37: " + [ v.constructor.name ]);
  };
  ...
  var modeToString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 65, column 1 - line 66, column 1: " + [ v.constructor.name ]);
  };
  ...
  var interactiveTColorScale = new Sparkle.Interactive(function (ui) {
      ...
      return Data_Functor.map(Flare.functorUI)(function ($83) {
          return Sparkle.SetHTML.create(pretty($83));
      })(ui);
  });
  ...
  var flammableTColorScale = new Sparkle.Flammable(Data_Functor.map(Data_NonEmpty.functorNonEmpty(Data_List_Types.functorList))(function ($84) {
      return TColorScale(toColorScale($84));
  })(new Data_NonEmpty.NonEmpty(Spectrum.value, new Data_List_Types.Cons(SpectrumLCh.value, new Data_List_Types.Cons(BlueToRed.value, Data_List_Types.Nil.value)))), function (v) {
      return Data_Functor.map(Flare.functorUI)(function ($85) {
          return TColorScale(toColorScale($85));
  ...
  var flammableTColor = new Sparkle.Flammable(Data_Functor.map(Data_NonEmpty.functorNonEmpty(Data_List_Types.functorList))(TColor)(new Data_NonEmpty.NonEmpty(Color.hsl(231.0)(0.48)(0.38), new Data_List_Types.Cons(Color_Scheme_MaterialDesign.blue, new Data_List_Types.Cons(Color_Scheme_MaterialDesign.orange, Data_List_Types.Nil.value)))), function (v) {
      var col = Color.toHSLA(v);
      return Data_Functor.map(Flare.functorUI)(TColor)(Flare.fieldset("Color")(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(Color.hsl)(Flare.numberSlider("Hue")(0.0)(360.0)(0.1)(col.h)))(Flare.numberSlider("Saturation")(0.0)(1.0)(1.0e-3)(col.s)))(Flare.numberSlider("Lightness")(0.0)(1.0)(1.0e-3)(col.l))));
  });
  var flammableTBlendMode = new Sparkle.Flammable(Data_Functor.map(Data_NonEmpty.functorNonEmpty(Data_List_Types.functorList))(TBlendMode)(new Data_NonEmpty.NonEmpty(Color_Blending.Multiply.value, new Data_List_Types.Cons(Color_Blending.Screen.value, new Data_List_Types.Cons(Color_Blending.Overlay.value, Data_List_Types.Nil.value)))), function (v) {
      return Data_Functor.map(Flare.functorUI)(TBlendMode)(Flare.select(Data_Foldable.foldableArray)("BlendMode")(new Data_NonEmpty.NonEmpty(Color_Blending.Multiply.value, [ Color_Blending.Screen.value, Color_Blending.Overlay.value ]))(modeToString));
  });
  var flammableInt255 = new Sparkle.Flammable(Data_Functor.map(Data_NonEmpty.functorNonEmpty(Data_List_Types.functorList))(Int255)(new Data_NonEmpty.NonEmpty(127, new Data_List_Types.Cons(50, new Data_List_Types.Cons(200, new Data_List_Types.Cons(0, Data_List_Types.Nil.value))))), function (v) {
      return Data_Functor.map(Flare.functorUI)(Int255)(Flare.intSlider("Int")(0)(255)(v));
  });
  ...
  var csToString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 75, column 1 - line 76, column 1: " + [ v.constructor.name ]);
  };
  var flammableTColorSpace = new Sparkle.Flammable(Data_Functor.map(Data_NonEmpty.functorNonEmpty(Data_List_Types.functorList))(TColorSpace)(new Data_NonEmpty.NonEmpty(Color.HSL.value, new Data_List_Types.Cons(Color.RGB.value, new Data_List_Types.Cons(Color.LCh.value, new Data_List_Types.Cons(Color.Lab.value, Data_List_Types.Nil.value))))), function (v) {
      return Data_Functor.map(Flare.functorUI)(TColorSpace)(Flare.select(Data_Foldable.foldableArray)("ColorSpace")(new Data_NonEmpty.NonEmpty(Color.HSL.value, [ Color.RGB.value, Color.LCh.value, Color.Lab.value ]))(csToString));
  });
  ...
  var interactiveColorList = new Sparkle.Interactive(function (ui) {
      var pretty = function (v) {
      ...
      return Data_Functor.map(Flare.functorUI)(function ($86) {
          return Sparkle.SetHTML.create(pretty($86));
      })(ui);
  });
  var interactiveTColor = new Sparkle.Interactive(function (ui) {
      return Data_Functor.map(Flare.functorUI)(function ($87) {
          return Sparkle.SetHTML.create(colorBox(runTColor($87)));
      })(ui);
  });
  ...
  var main = function __do() {
      Test_FlareDoc.withPackage("purescript-colors.json")(function (dict) {
          ...
          return function __do() {
              doc(Sparkle.interactiveFunction(flammableTColor)(interactiveTColor))("hsl")(Control_Category.id(Control_Category.categoryFn))();
              doc(Sparkle.interactiveFunction(flammableInt255)(Sparkle.interactiveFunction(flammableInt255)(Sparkle.interactiveFunction(flammableInt255)(interactiveTColor))))("rgb")(function (v) {
                  return function (v1) {
                      return function (v2) {
              ...
              doc(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveString))("toHexString")(Color.toHexString)();
              doc(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveString))("cssStringHSLA")(Color.cssStringHSLA)();
              doc(interactiveTColor)("black")(Color.black)();
              doc(interactiveTColor)("white")(Color.white)();
              doc(Sparkle.interactiveFunction(Sparkle.flammableSmallNumber)(interactiveTColor))("graytone")(function (v) {
                  return Color.graytone(v);
              })();
              doc(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveColor))("complementary")(Color.complementary)();
              doc(Sparkle.interactiveFunction(Sparkle.flammableSmallNumber)(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveTColor)))("lighten")(function (v) {
                  return function ($88) {
                      return TColor(Color.lighten(v)($88));
                  };
              })();
              doc(Sparkle.interactiveFunction(Sparkle.flammableSmallNumber)(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveTColor)))("darken")(function (v) {
                  return function ($89) {
                      return TColor(Color.darken(v)($89));
                  };
              })();
              doc(Sparkle.interactiveFunction(Sparkle.flammableSmallNumber)(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveTColor)))("saturate")(function (v) {
                  return function ($90) {
                      return TColor(Color.saturate(v)($90));
                  };
              })();
              doc(Sparkle.interactiveFunction(Sparkle.flammableSmallNumber)(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveTColor)))("desaturate")(function (v) {
                  return function ($91) {
                      return TColor(Color.desaturate(v)($91));
                  };
              })();
              doc(Sparkle.interactiveFunction(flammableTColorSpace)(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveFunction(Sparkle.flammableSmallNumber)(interactiveTColor)))))("mix")(function (v) {
                  return function (b) {
                      return function (f) {
                          return function (v1) {
                              return Color.mix(v)(b)(f)(v1);
                          };
                      };
                  };
              })();
              doc(Sparkle.interactiveFunction(Sparkle.flammableNumber)(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveFunction(Sparkle.flammableSmallNumber)(interactiveTColor)))))("mixCubehelix")(function (gamma) {
                  return function (b) {
                      return function (f) {
                          return function (v) {
                              return Color.mixCubehelix(gamma)(b)(f)(v);
                          };
                      };
                  };
              })();
              doc(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveNumber))("brightness")(Color.brightness)();
              doc(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveNumber))("luminance")(Color.luminance)();
              doc(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveTColor))("textColor")(function ($92) {
                  return TColor(Color.textColor($92));
              })();
              var docblend = function (dictInteractive) {
                  return Test_FlareDoc["flareDoc'"](dictInteractive)("doc-blending")(dict)("Color.Blending");
              };
              docblend(Sparkle.interactiveFunction(flammableTBlendMode)(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveTColor))))("blend")(function (v) {
                  return function (b) {
                      return function (f) {
                          return Color_Blending.blend(v)(b)(f);
                      };
                  };
              })();
              ...
              docscale(Sparkle.interactiveFunction(flammableTColorSpace)(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveTColorScale))))("colorScale")(function (v) {
                  return function (b) {
                      return function (e) {
                          return TColorScale(Color_Scale.colorScale(v)(b)(Data_List_Types.Nil.value)(e));
                      };
                  };
              })();
              docscale(Sparkle.interactiveFunction(flammableTColorScale)(Sparkle.interactiveFunction(Sparkle.flammableSmallNumber)(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveTColorScale))))("addStop")(function (v) {
                  return function (v1) {
                      return function (c) {
                          return TColorScale(Color_Scale.addStop(v)(c)(v1));
                      };
                  };
              })();
              docscale(Sparkle.interactiveFunction(flammableTColorScale)(Sparkle.interactiveFunction(Sparkle.flammableSmallNumber)(interactiveTColor)))("sample")(function (v) {
                  return function (v1) {
                      return Color_Scale.sample(v)(v1);
                  };
              })();
              docscale(Sparkle.interactiveFunction(flammableTColorScale)(Sparkle.interactiveFunction(Sparkle.flammableSmallInt)(interactiveColorList)))("colors")(function (v) {
                  return function (v1) {
              ...
              docscale(Sparkle.interactiveFunction(flammableTColorSpace)(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveString))))("cssColorStops")(function (v) {
                  return function (b) {
                      return function (e) {
                          return Color_Scale.cssColorStops(Color_Scale.colorScale(v)(b)(Data_List_Types.Nil.value)(e));
                      };
                  };
              })();
              docscale(Sparkle.interactiveFunction(flammableTColorScale)(interactiveTColorScale))("modify (here: modify (const toGray))")(function (v) {
              ...
              docharm(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveColorList))("analogous")(function (c) {
                  return ColorList.create(Color_Scheme_Harmonic.analogous(c));
              })();
              docharm(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveColorList))("triad")(function (c) {
                  return ColorList.create(Color_Scheme_Harmonic.triad(c));
              })();
              docharm(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveColorList))("splitComplementary")(function (c) {
                  return ColorList.create(Color_Scheme_Harmonic.splitComplementary(c));
              })();
              docharm(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveColorList))("shades")(function (c) {
                  return ColorList.create(Color_Scheme_Harmonic.shades(c));
              })();
              docharm(Sparkle.interactiveFunction(Sparkle.flammableColor)(interactiveColorList))("tetrad")(function (c) {
                  return ColorList.create(Color_Scheme_Harmonic.tetrad(c));
              })();
