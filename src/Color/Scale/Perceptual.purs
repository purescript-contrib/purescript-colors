...
_magma_data :: Array (Array Number)
...
_inferno_data :: Array (Array Number)
...
_plasma_data :: Array (Array Number)
...
_viridis_data :: Array (Array Number)
...
matplotlibScale rgbs = uniformScale RGB start middle stop
  where start = toColor (head rgbs)
        ...
        stop = toColor (last rgbs)
        toColor [r, g, b] = rgb' r g b
        toColor _         = rgb' 0.0 0.0 0.0
